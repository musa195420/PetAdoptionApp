  ...
  Widget _buildButton(String animalId) {
    return Container(
      ...
      child: GestureDetector(
        child: Text(
          "Add Animal Disability",
          style: TextStyle(fontWeight: FontWeight.w600, color: Colors.white),
        ),
        onTap: () async {
          if (formKey.currentState!.validate()) {
            var addAnimalRes = await _apiService.addDisability(AddInBulk(name: petController.text.toString()  ,animalId:animalId));
           
           if(addAnimalRes.errorCode=="PA0004")
           {
            await _dialogService.showSuccess(text:"Disability Added SucessFully");
           }
          }
        },
      ),
