      ...
      child: GestureDetector(
        ...
        onTap: () async {
          if (formKey.currentState!.validate()) {
            var addAnimalRes = await _apiService.addDisease(AddInBulk(name: petController.text.toString()  ,animalId: animalId));
           
           if(addAnimalRes.errorCode=="PA0004")
           {
            await _dialogService.showSuccess(text:"Disease Added SucessFully");
           }
          }
        },
      ),
