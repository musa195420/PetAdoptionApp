...
class DonorAdmin extends StatelessWidget {
  ...
  Widget _buildUserCard(
      BuildContext context, UserProfile user, DonorAdminViewModel viewModel) {
    String displayText = user.isActive == true ? "Live" : "Offline";
    Color color = user.isActive == true ? Colors.green : Colors.red;
