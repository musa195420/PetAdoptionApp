...
class SecureAdminView extends StatelessWidget {
  ...
  Widget _buildUserCard(BuildContext context, SecureMeetup secure, SecuremeetupAdminViewModel viewModel) {
          ...
          children: [
            ...
            Expanded(
              child: Column(
                  ...
                  Row(
                    children: [
                      Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(secure.currentAddress ?? "", style: Theme.of(context).textTheme.titleMedium),
                           Text(secure.time ?? "", style: Theme.of(context).textTheme.titleMedium),
                        ],
                      ),
                      Spacer(),
                        Flexible(child: Text(secure.phoneNumber ?? "", style: Theme.of(context).textTheme.titleMedium)),
                ...
                child: Center(
                  child: Text(secure.approval ??"", style: TextStyle(color: color, fontWeight: FontWeight.bold)),
                ),
              ),
                        ],
                      ),
